...
admin_router.patch('/product/:id', isAdmin, validateObjectId('id'), productController.updatePublishStatus);
admin_router.get('product/edit/:id', isAdmin, validateObjectId('id'), productController.editProductPage)
admin_router.post('/product/edit/:id', isAdmin, validateObjectId('id'), productController.editProduct)
...
admin_router.patch('/category/:id', isAdmin, validateObjectId('id'), categoryController.updateCategoryListStatus);
admin_router.get('/category/edit/:id', isAdmin, validateObjectId('id'), categoryController.editCategoryPage)
admin_router.post('/category/edit/:id', isAdmin, validateObjectId('id'), categoryController.editCategory)
...
admin_router.patch('/brand/:id', isAdmin, validateObjectId('id'), brandController.updateBrandListStatus);
admin_router.get('/brand/edit/:id', isAdmin, validateObjectId('id'), brandController.editBrandPage)
admin_router.post('/brand/edit/:id', isAdmin, validateObjectId('id'), brandController.editBrand)
...
admin_router.get('/coupon/:couponId', isAdmin, validateObjectId('couponId'), couponController.editCouponPage);
admin_router.post('/coupon/:id', isAdmin, validateObjectId('id'), couponController.editCoupon);
admin_router.patch('/coupon/:id', isAdmin, validateObjectId('id'), couponController.toggleCouponStatus);



//////////////orders\\\\\\\\\\\\\\\\
admin_router.get('/orderlist', isAdmin, orderController.orderList)
admin_router.get('/userOrderDetails/:id', isAdmin, validateObjectId('id'), orderController.userOrderDetails)
